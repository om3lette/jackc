...
[[nodiscard]] jack_token jack_lexer_new_str_token(jack_lexer* lexer, int32_t type, const char* start);

[[nodiscard]] jack_token jack_lexer_new_int_token(jack_lexer* lexer, const char* start, jack_int value);
